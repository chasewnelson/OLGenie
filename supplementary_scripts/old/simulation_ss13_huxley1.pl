...
#my $random_seed = srand (time|$$);  # introduce a random seed each time
...
foreach my $dnds_1 (@dnds_1_values){
    foreach my $dnds_2 (@dnds_2_values){
        ...
        #my $sample_size = 2^10; # 1,024; this is the sample size before, not replaced by branching events
        #my $number_of_codons=100000;
        #my $number_of_codons=1000;
        #my $distance = 0.2; #This now is the longest distance between two sequences
